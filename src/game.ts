...
import { addCanopy } from "./modules/canopy";
import { addLampPost } from "./modules/lampPost";
import { addTable } from "./modules/table";
import { addTerminal } from "./modules/terminal";
